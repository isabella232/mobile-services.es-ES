...
* **loadRequest**
   ...
   * Este es un ejemplo de código para este método:
      ...
      Para obtener más información sobre la API de Target subyacente, consulte [Cargar solicitudes de Target](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/adobe-target/target-api-reference-deprecated#load-target-requests) en la referencia de la API de Target.
